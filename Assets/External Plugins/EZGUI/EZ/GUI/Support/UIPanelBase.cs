...
*/
	...
	public virtual void StartTransition(UIPanelManager.SHOW_MODE mode)
	{
		...
		// Send a message to the children detailing the transition that has started
		BroadcastMessage("PanelTransitionStarted", name + "_" + mode, SendMessageOptions.DontRequireReceiver);
	...
	public virtual void StartTransition(string transName)
	{
		...
		// Send a message to the children detailing the transition that has started
		BroadcastMessage("PanelTransitionStarted", transName, SendMessageOptions.DontRequireReceiver);
