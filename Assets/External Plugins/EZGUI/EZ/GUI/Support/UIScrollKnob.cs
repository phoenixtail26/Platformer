...
public class UIScrollKnob : UIButton
{
	...
	public void SetupAppearance()
	{
		...
		// This is correctly setting up the initial UVs
		if ( animations.Length > 0 )
		{
			if ( animations[0].GetFrameCount() > 0 )
			{
				CSpriteFrame frame = new CSpriteFrame(animations[0].GetFrame(0));
				frameInfo.Copy(frame);
			}
		}
