...
{
    [MenuItem("Custom/Sound/Modify Clip Properties")]
    static void ModifySoundClipProperties()
    {
        ChangeAudioImportSettingsWindow window = (ChangeAudioImportSettingsWindow)EditorWindow.GetWindow<ChangeAudioImportSettingsWindow>();
        window.Init();
    }
